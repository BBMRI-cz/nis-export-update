...
def _slide_preparation_assay_to_dto(
    ...
    return SlidePreparationAssayDto(
        ...
        whole_slide_imaging=_whole_slide_imaging_to_dto(assay.whole_slide_imaging),
    )
...
def _slide_container_to_dto(
    ...
    return SlideContainerDto(
        ...
        slide_preparation_assay=_slide_preparation_assay_to_dto(
            slide_container.slide_preparation_assay
        ),
    )


def _fixed_block_to_dto(fixed_block: FixedBlock | None) -> FixedBlockDto | None:
    ...
    return FixedBlockDto(
        ...
        slide_container=_slide_container_to_dto(fixed_block.slide_container),
    )


def build_wsi_catalogue_dto(wsi: WsiData) -> dict[str, Any]:
    fixed_block_dto = _fixed_block_to_dto(wsi.fixed_block)
    return {
